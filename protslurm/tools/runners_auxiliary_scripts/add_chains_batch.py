...
from protslurm.utils.biopython_tools import add_chain, get_atoms, get_atoms_of_motif, load_structure_from_pdbfile, save_structure_to_pdbfile, superimpose
...
def main(args) -> None:
    ...
    for target, opts in poses_dict.items():
        superimpose_add_chain_pdb(
            ...
            target_motif = ResidueSelection(opts["target_motif"]),
            reference_motif = ResidueSelection(opts["reference_motif"]),
