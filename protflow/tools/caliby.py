...
class CalibySequenceDesign(Runner):
    ...
    def __init__(self, caliby_dir: str|None = None, python_path: str|None = None, pre_cmd: str|None = None, jobstarter: JobStarter = None) -> None:
        ...
        self.caliby_dir = dir_path or load_config_path(config, "CALIBY_DIR_PATH")
    ...
    def run(self, poses: Poses, prefix: str, jobstarter: JobStarter = None, nseq: int = 1, model_type: str = "caliby", options: str = None, pose_options: object = None, fixed_pos_seq_col: str = None, fixed_pos_scn_col: str = None, fixed_pos_override_seq_col: str = None, pos_restrict_aatype_col: str = None, symmetry_pos_col: str = None, preserve_original_output: bool = False, overwrite: bool = False, num_batches: int = None) -> Poses:
        """
        ...
        for pose in poses.poses_list():
            pose_opt_dict = self.parse_caliby_opts(options, pose_options)
            pose_opt_dict.set_default("sampling_cfg_overrides.num_seqs_per_pdb", nseq) # add number of sequences, if not defined in opts/pose_opts
    ...
    def parse_caliby_opts(self, options: str = None, pose_options: str = None) -> dict:
        # 1. Normalize None to empty strings immediately
        options = options or ""
        pose_options = pose_options or ""

        def re_split_shell_style(command: str) -> list:
            # 2. Return empty list if the string is empty
        ...
        raw_splits = re_split_shell_style(options) + re_split_shell_style(pose_options)
